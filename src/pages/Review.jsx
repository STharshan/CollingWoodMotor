...
export default function ReviewPage() {
    ...
    const EMAILJS_TEMPLATE_ID = 'template_z8n4quc'; // Replace with your EmailJS template ID
        ...
        <div className="min-h-screen bg-gradient-to-br mt-20 from-amber-50 via-orange-50 to-rose-50 flex items-center justify-center p-4 sm:p-6 md:p-8">
            <div className="w-full mt-20 max-w-2xl">
                ...
                <div className="bg-white rounded-3xl shadow-2xl shadow-orange-200/50 overflow-hidden backdrop-blur-sm">
                    {/* Header Section */}
                    <div className="bg-[#028BFA] px-6 sm:px-8 md:px-12 py-8">
                    ...
                    <div className="px-6 sm:px-8 md:px-12 py-8 sm:py-10 md:py-12">
                        ...
                        <div className="mb-8">
                            ...
                            {rating > 0 && (
                                <p className="text-center mt-4 text-lg sm:text-xl font-semibold text-[#028BFA] animate-fade-in">
                        ...
                        {showReviewBox && !submitted && (
                            <div className="animate-slide-down">
                                <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-6 sm:p-8 border-2 border-[#028BFA] shadow-lg">
                                    <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                                        <svg className="w-6 h-6 text-[#028BFA]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        ...
                                        <button
                                            type="submit"
                                            disabled={loading}
                                            className={`w-full bg-[#028BFA] text-white font-bold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 text-base sm:text-lg focus:outline-none focus:ring-4 focus:ring-orange-300 ${loading ? 'opacity-70 cursor-not-allowed' : ''
                                                }`}
                                        >
                                            {loading ? (
