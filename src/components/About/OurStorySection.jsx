...
const OurStorySection = () => {
  return (
    <section className="bg-white py-20 px-6 md:px-12 lg:px-24 text-center">
      ...
      {/* Heading */}
      <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-700 leading-tight max-w-3xl mx-auto mb-8 uppercase">
      ...
      <p className="max-w-md mx-auto text-gray-600 text-base md:text-lg leading-relaxed">
        Welcome to Collingwood Motors, proudly voted the<strong> Best Family-Run Repair Garage of 2024</strong> and recognized as 
