  ...
  return (
    <footer className="bg-white dark:bg-black border-t border-gray-200 dark:border-gray-800 text-black dark:text-gray-200 text-sm transition-colors duration-300">
      <div className="mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 xl:gap-50 items-start">
        ...
        <div className="flex flex-col justify-between mx-auto">
          <div className="space-y-4">
            <div className="group flex justify-between items-center border-b border-gray-300 dark:border-gray-700 pb-2 hover:border-blue-600 dark:hover:border-blue-400 cursor-pointer">
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 mt-10 text-center font-semibold text-sm text-gray-500 dark:text-gray-400 py-6">
        © 2024 Collingwood Motors. All rights reserved. <span className="mx-2">|</span>
        Partnered With{' '}
        <a
