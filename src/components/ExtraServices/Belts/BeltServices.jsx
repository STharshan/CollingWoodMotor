        ...
        <div className="flex flex-col-reverse lg:flex-row px-4 lg:px-16 py-10 mt-20 gap-8 w-full max-w-screen-xl mx-auto">
            ...
            <main className="w-full lg:w-2/3 text-gray-800">
                ...
                <div className="border-l-4 border-blue-600 p-4 text-sm lg:text-base mt-10 mb-6">
                    <p className="text-xl"><strong>CM Pro Tip:</strong> While timing chains typically last longer than belts, they can still wear over time. Regular oil changes and ensuring your engine has the right oil level can help prolong the life of your timing chain and prevent expensive repairs.</p>
                </div>
