  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white max-w-3xl mt-20">
        ...
        >
        MOT Testing Specialists
        </span>

        {/* Heading */}
        <h2 className="text-4xl font-semibold text-[#028BFA] mb-5 uppercase">Ministry of Transport (MOT) Testing Services</h2>

        {/* Subtext */}
        <p className="text-gray-300 text-base md:text-lg font-semibold">
          Reliable, stress-free MOT testing carried out by certified technicians to ensure your vehicle meets all safety and environmental standards.
        </p>
