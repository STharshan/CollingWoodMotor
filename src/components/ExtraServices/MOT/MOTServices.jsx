        ...
        <div className="flex flex-col-reverse lg:flex-row px-4 lg:px-16 py-10 mt-20 gap-8 w-full max-w-screen-xl mx-auto">
            ...
            <main className="w-full lg:w-2/3 text-gray-800">
                ...
                <ol className="list-disc pl-6 space-y-2 text-sm lg:text-base">
                    <li><strong>Thorough Inspections for Peace of Mind:</strong> Our certified technicians perform comprehensive checks to ensure your vehicle meets all safety and environmental standards.</li>
                    <li><strong>Fast, Reliable Service: </strong>We offer quick turnaround times, so you can get back on the road without delay.</li>
                    <li><strong>Transparent Pricing and Quality: </strong>With clear pricing and a commitment to high-quality service, you can trust us for an honest and stress-free MOT experience.</li>
