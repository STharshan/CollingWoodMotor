  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white max-w-3xl mt-20">
        ...
        {/* Heading */}
        <h2 className="text-4xl font-semibold text-[#028BFA] mb-5 uppercase">Professional Automotive Services</h2>

        {/* Subtext */}
        <p className="text-gray-300 text-base md:text-lg font-semibold">
          Comprehensive vehicle maintenance and repair services delivered by master technicians you can trust
        </p>
