        ...
        <div className="flex flex-col-reverse lg:flex-row px-4 lg:px-16 py-10 mt-20 gap-8 w-full max-w-screen-xl mx-auto">
            ...
            <main className="w-full lg:w-2/3 text-gray-800">
                ...
                <ol className="list-disc pl-6 space-y-2 text-sm lg:text-base">
                    <li><strong>Master Technicians at Your Service:</strong> Our expert technicians have the skills and experience to handle any mechanical repair, no matter how complex.</li>
                    <li><strong>Comprehensive Repair Solutions: </strong>From routine maintenance to major repairs, we do it all, ensuring your vehicle gets the care it needs.</li>
                    <li><strong>Reliable, High-Quality Service: </strong>We take pride in delivering top-notch repairs that keep your vehicle running smoothly and safely for the long haul.</li>                   
                </ol>
            </main>
        </div>
    );
