      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg max-w-2xl mx-auto text-[var(--aircon-muted)]">
            Recognise the signs your vehicle needs a diagnostic check
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <SectionCard
            title="Warning Signs"
            description="Common indicators diagnostics are required"
            items={[
          ...
          <SectionCard
            ...
            description="Why proactive checks matter"
            items={[
              "No warning lights but reduced performance",
              "Before long journeys or holidays",
