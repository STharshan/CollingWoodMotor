        ...
        <div className="flex flex-col-reverse lg:flex-row px-4 lg:px-16 py-10 mt-20 gap-8 w-full max-w-screen-xl mx-auto">
                        ...
                        <li key={index}>
                            <Link
                                ...
                                className={`block pl-2 transition-all duration-150 ${location.pathname === item.path
                                    ? "font-semibold border-l-4 border-blue-600 text-black"
            ...
            <main className="w-full lg:w-2/3 text-gray-800">
                ...
                <ol className="list-disc pl-6 space-y-2 text-sm lg:text-base">
                    <li><strong>Precise, Expert Alignment:</strong>Our skilled technicians use advanced equipment to ensure your wheels are perfectly aligned for smooth, safe driving. </li>
                    <li><strong>Enhanced Tire Longevity and Fuel Efficiency:</strong> Proper alignment helps your tires wear evenly, saving you money on replacements and improving fuel efficiency.</li>
                    <li><strong>Improved Handling and Safety:</strong> Get better control and a smoother ride, with alignment that enhances your vehicle's overall performance and safety.</li>          
                </ol>
