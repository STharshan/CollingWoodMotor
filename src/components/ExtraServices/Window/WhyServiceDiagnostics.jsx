      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4 text-[#028BFA]">
            When Do You Need Window Tinting?
          </h2>
          <p className="text-lg max-w-2xl mx-auto text-[var(--aircon-muted)]">
            Signs your vehicle would benefit from professional tinting
          </p>
        </div>

        <div className="grid lg:grid-cols-2 gap-8">
          <SectionCard
            title="Heat & Glare Issues"
            description="Indicators your windows need tinting"
            items={[
              "Excessive cabin heat",
              "Glare while driving",
              "Faded interior trim",
              "Uncomfortable summer driving",
            ]}
          />

          <SectionCard
            title="Privacy Concerns"
            description="When privacy and security are important"
            items={[
              "Valuables visible inside vehicle",
              "Desire for increased discretion",
              "Family or child safety considerations",
            ]}
          />
        </div>
      </div>
