      ...
      {visible && (
        <div className="fixed bottom-4 left-4 right-4 md:bottom-6 text-center md:right-6 md:left-auto max-w-full md:max-w-xs p-4 rounded-lg 
          ...
          <p className="mb-3">
            <a
              href="/privacy"
              className="underline text-[#028BFA] hover:text-[#868386] "
            >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3">
            <button
              ...
              className="bg-[#028BFA] text-white px-4 py-2 rounded text-sm hover:bg-[#868386]  transition"
            >
              Reject
            </button>
            <button
      ...
      {showIcon && !visible && (
        <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-40">
          <button
            ...
            className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#028BFA] shadow-lg border border-white 
