          ...
          <div className="max-w-6xl mx-auto">
              ...
              <div className="mt-8 space-y-6">
                  ...
                  <section>
                      ...
                      <p className="text-white">
                          All content on this website (including text, images, graphics, and logos) is owned by or licensed to  Collingwood Motors.
                  ...
                  <section>
                      ...
                      <div className="text-white">
                          <p><strong>Collingwood Motors</strong></p>
                          ...
                          <p>Phone: 07564 693973</p>
                          <p>Address: 21 Slater St, Leicester LE3 5AS, United Kingdom</p>
                      </div>
                  </section>
              </div>
          </div>
